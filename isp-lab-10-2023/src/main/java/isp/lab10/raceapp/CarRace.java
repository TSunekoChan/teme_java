...
class Car extends Thread {
    ...
    private isp.lab10.raceapp.semaphoreThread semaphoreThread;
    private PlaySound sound=new PlaySound();
    private RankingPanel rankingPanel;
    private JFrame frame;

    public Car(String name, CarPanel carPanel, isp.lab10.raceapp.semaphoreThread semaphoreThread, RankingPanel panel, JFrame frame) {
        //set thread name;
        setName(name);
        this.name = name;
...
class CarPanel extends JPanel {
    ...
    public CarPanel() {
        ...
        carNames =  new String[]{"BMW", "Logan", "Subaru", "Supra"};
